            ...
            <div className='flex items-center gap-4 relative'>
                {
                    token && userData
                        ...
                        >
                            ...
                            {/* Dropdown */}
                            <div
                                className={`absolute right-0 top-12 min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4 text-base font-medium text-gray-600 z-20 ${showDropdown ? 'block' : 'hidden'}`}
                            >
                                <p
                                    onClick={(e) => {
                                        navigate('/my-profile');
